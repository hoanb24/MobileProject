        ...
        <View style={styles.content}>
          <View style={styles.flatListItem}>
            <SwipeListView
              ...
              renderItem={(data, rowMap) => <Items data={data} />}
              // render hiden items
        ...
        <View style={styles.footer}>
          <View style={styles.totalPayment}>
            ...
            <View style={[styles.detailInvoid, { fontSize: 30 }]}>
              <Text style={{ fontSize: 20, color: "#FEFEFF", paddingTop:10, }}> Total</Text>
              <Text style={{ fontSize: 20, color: "#FEFEFF", paddingTop:10, }}> 2 $</Text>
            </View>
          </View>
