...
export default function CallRinging({ navigation }) {
  useEffect(() => {
    setTimeout(() => navigation.navigate("call"), 5000);
  }, []);
  return (
    <ImageBackground
      ...
      <View style={styles.container}>
        <View style={styles.userImageFrame}>
          <Image
            ...
            source={require("../../assets/images/Klein.png")}
          />
        </View>
        <View style={styles.userNameFrame}>
          <Text style={styles.userName}>Lê Xuân</Text>
          <Text style={styles.ringingAction}>Ringing . . .</Text>
        </View>
